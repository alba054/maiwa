...
class Wirehasil extends Component
{
    ...
    protected $messages = [
        'hasil.required' => 'Keterangan hasil diisi dlu bre.',
    ];
    protected $listeners =[
        'delete',
        'cancelled'
    ...
    {
        return view('livewire.wirehasil',[
            'datas' => $this->resultData()
        ]);
    }
    public function resultData()
    {
        return Hasil::orderBy('hasil', 'ASC')
        ->where(function ($query){
            if($this->searchTerm != ""){
                $query->where('hasil','like','%'.$this->searchTerm.'%');
            }
        })
        ->get();
    ...
    {
        $data = Hasil::find($this->selectedItemId);
    ...
    public function update($data)
    {
        ...
        $save = Hasil::find($this->selectedItemId)->update($data);
    ...
    public function delete()
    {
        ...
        $delete = Hasil::destroy($this->selectedItemId);
