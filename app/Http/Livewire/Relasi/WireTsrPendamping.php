...
class WireTsrPendamping extends Component
{
    use WithPagination;
    protected $paginationTheme = 'bootstrap';
    public $tsr_id, $pendamping_id, $date, $selectedItemId, $searchTerm, $pendampingId, $tsrId;
    ...
    protected $messages = [
        'tsr_id.required' => 'this field is required.',
    ...
    {
        return view('livewire.relasi.wire-tsr-pendamping',[
    ...
    public function submit()
    {
        ...
        $save = $this->selectedItemId ?   TsrPendamping::find($this->selectedItemId)->update($data) : TsrPendamping::create($data);
    ...
    public function edit(){
        $data = TsrPendamping::find($this->selectedItemId);
        $this->tsr_id = $data->tsr_id;
        $this->pendamping_id = $data->pendamping_id;
    }
    public function delete(){
        $delete = TsrPendamping::destroy($this->selectedItemId);
