...
class WireMonSakitSearch extends Component
{
    public $startDate, $endDate, $sapiId, $peternakId, $pendampingId, $tsrId, $status;

    public function render()
    {
        return view('livewire.sakit.wire-mon-sakit-search',[
            'sapis' => $this->dataSapi(),
