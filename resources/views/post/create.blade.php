    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Create Post</a>
                </li>
            </ol>
        </div>
...
@section('content')
    ...
    <form class="card" action="{{ route('posts.store') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card-body ">
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    <input wire:model="state.title" class="form-control @error('title') is-invalid @enderror"
                        placeholder="Post title" value="" autofocus name="title">
            ...
            <div class="form-group">
                ...
                <textarea class="content @error('detail') is-invalid @enderror" name="detail" id="detail"></textarea>
