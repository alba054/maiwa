                    ...
                    <ul class="horizontalMenu-list">
                        ...
                        <li aria-haspopup="true">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li aria-haspopup="true"><a href="{{ url('/users/3') }}"> Data
                                        TSR</a>
                                </li>
                        ...
                        <li aria-haspopup="true">
                            ...
                            <ul class="sub-menu">
                                {{-- <li aria-haspopup="true"><a href="{{ url('/' . ($page = 'ternak')) }}"> Form
                                        Ternak</a></li> --}}
                                <li aria-haspopup="true"><a href="{{ url('/' . ($page = 'kelompok')) }}">Form
                                        Kelompok</a></li>

                                <li aria-haspopup="true"><a href="{{ url('/' . ($page = 'metode')) }}">Form Metode
                                        PKB</a></li>
                                <li aria-haspopup="true"><a href="{{ url('/' . ($page = 'hasil')) }}">Form Hasil
                                        PKB</a></li>

                                <li aria-haspopup="true"><a href="{{ url('/' . ($page = 'obat')) }}">Form Obat</a>
                                </li>
                                <li aria-haspopup="true"><a href="{{ url('/' . ($page = 'vaksin')) }}">Form
                                        Vaksin</a></li>
                                <li aria-haspopup="true"><a href="{{ url('/' . ($page = 'vitamin')) }}">Form
                                        Vitamin</a></li>
                        ...
                        <li aria-haspopup="true">
                            ...
                            <ul class="sub-menu">
                                <li aria-haspopup="true"><a
                                        ...
                                        Kebuntingan</a></li>
                                <li aria-haspopup="true"><a
                                        href="{{ url('/' . ($page = 'monitoring-performa')) }}">Performa
                                        (Recording)</a>
                                </li>
                                <li aria-haspopup="true"><a
                                ...
                                <li aria-haspopup="true"><a
                                        href="{{ url('/' . ($page = 'monitoring-perlakuan')) }}">Perlakuan
                                        Kesehatan</a>
                                </li>
                            </ul>
                        </li>
