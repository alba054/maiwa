...
@section('page-header')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}"><i class="fe fe-layers mr-2 fs-14"></i>Ternak</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page"><a href="#">Form Ternak</a>
                </li>
            </ol>
        </div>
...
@section('js')
    ...
    <script>
        ...
        $('#appointmentDate').on("change.datetimepicker", function(e) {
            ...
            eval(date).set('tgl_mulai', $('#appointmentDateInput').val());
