 <div>
     ...
     <div class="page-header">
         <div class="page-leftheader">
             <h4 class="page-title mb-0">Performa</h4>
             <ol class="breadcrumb">
     ...
     <div class="row">
         ...
         <div class="col-xl-12 col-lg-12 col-md-12" wire:ignore>
             <div class="card">
                 <div class="card-header">
                     <h3 class="card-title">Grafik Performa (Recording)</h3>
                 ...
                 <div class="card-body">
                     ...
                     <div class="text-center mt-2">
                         ...
                         <span><span class="dot-label bg-warning"></span>Data Performa (Recording)</span>
                     </div>
                 </div>
             </div>
         </div>
