<div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-2">
                        <span class="mr-4"><span class="dot-label bg-info"></span>Data Kelahiran</span>
                        <span class="mr-4"><span class="dot-label bg-danger"></span>Data Kematian</span>
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Upah Pendamping</h3>
        ...
        <div class="col-xl-6 col-lg-6 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Jenis Kelamin Sapi</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-2">
                        <span class="mr-4"><span class="dot-label bg-info"></span>Data Sapi Jantan</span>
                        <span><span class="dot-label bg-danger"></span>Data Sapi Betina</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    @push('script')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                //     console.log("element.initialized 8");


                // })
                // Livewire.hook('element.updating', (fromEl, toEl, component) => {
                //     console.log("element.initialized 7");

                // })
                // Livewire.hook('element.updated', (el, component) => {
                //     console.log("element.initialized 6");

                // })
                // Livewire.hook('element.removed', (el, component) => {
                //     console.log("element.initialized 5");

                // })
                // Livewire.hook('message.sent', (message, component) => {
                //     console.log("element.initialized 4");

                // })
                // Livewire.hook('message.failed', (message, component) => {
                //     console.log("element.initialized 3");

                // })
                // Livewire.hook('message.received', (message, component) => {
                //     console.log("element.initialized 2");
