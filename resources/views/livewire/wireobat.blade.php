<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input wire:model="name" type="text" class="form-control" placeholder="e.g: Paracetamol">
                    @error('name')
                        <small class="mt-2 text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group">
                    <label class="form-label">Detail Obat</label>
                    <input wire:model="detail" type="text" class="form-control"
                        placeholder="e.g: Penurun panas demam anak">
                    @error('detail')
                        <small class="mt-2 text-danger">{{ $message }}</small>
                    @enderror
                </div>
    ...
    <div class="col-xl-9 col-lg-8">
        <div class="card">
            <div class="card-header">
                <div class="col">
                    <div class="card-title">Tabel Obat</div>
                </div>
