<div class="row">
    <div class="col-xl-3 col-lg-4">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Form Tambah Upah</div>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input wire:model="status" type="number" class="form-control" placeholder="e.g: 1/2/3"
                ...
                <div class="form-group">
                    ...
                    <input wire:model="detail" type="text" class="form-control" placeholder="e.g: PKB">
                    @error('detail')
                        <small class="mt-2 text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input wire:model="price" type="number" class="form-control" placeholder="e.g: 15000">
                    @error('price')
                        <small class="mt-2 text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="card-footer text-right">
                <button wire:click="submit" class="btn btn-outline-primary">Submit</button>
            </div>
        </div>
    </div>
    <div class="col-xl-9 col-lg-8">
        <div class="card">
            <div class="card-header">
                <div class="col">
                    <div class="card-title">Tabel Upah</div>
                </div>
