<div class="row">
    <div class="col-xl-3 col-lg-4">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Tambah Vitamin</div>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input wire:model="name" type="text" class="form-control" placeholder="e.g: Vit Z">
                    @error('name')
                        <small class="mt-2 text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group">
                    <label class="form-label">Detail Vitamin</label>
                    <input wire:model="detail" type="text" class="form-control" placeholder="e.g: Kekebalan tubuh">
                    @error('detail')
                        <small class="mt-2 text-danger">{{ $message }}</small>
                    @enderror
                </div>
    ...
    <div class="col-xl-9 col-lg-8">
        <div class="card">
            <div class="card-header">
                <div class="col">
                    <div class="card-title">Tabel Vitamin</div>
                </div>
