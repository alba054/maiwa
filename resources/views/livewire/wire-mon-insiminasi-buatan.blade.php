 <div>
     ...
     <div class="page-header">
         <div class="page-leftheader">
             <h4 class="page-title mb-0">Insiminasi Buatan</h4>
             <ol class="breadcrumb">
                 <li class="breadcrumb-item"><a href="{{ url('/' . ($page = '#')) }}"><i
                             class="fe fe-layers mr-2 fs-14"></i>Monitoring</a></li>
                 <li class="breadcrumb-item active" aria-current="page"><a href="#">Insiminasi Buatan</a>
                 </li>
             </ol>
         </div>
     ...
     <div class="row">
         ...
         <div class="col-xl-12 col-lg-12 col-md-12" wire:ignore>
             <div class="card">
                 <div class="card-header">
                     <h3 class="card-title">Grafik Insiminasi Buatan {{ $yearNow }}</h3>
