<div class="row">
    <div class="col-xl-3 col-lg-4">
        <div class="card">
            <div class="card-header">
                <div class="card-title">Tambah Hasil</div>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    <label class="form-label">Hasil PKB</label>
                    <input wire:model="hasil" type="text" class="form-control" placeholder="e.g: hasil PKB">
                    @error('hasil')
    ...
    <div class="col-xl-9 col-lg-8">
        <div class="card">
            <div class="card-header">
                <div class="col">
                    <div class="card-title">Tabel Hasil PKB</div>
                </div>
