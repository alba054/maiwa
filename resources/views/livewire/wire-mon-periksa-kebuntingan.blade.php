<div>
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title mb-0">Periksa Kebuntingan</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/' . ($page = '#')) }}"><i
                            class="fe fe-layers mr-2 fs-14"></i>Monitoring</a></li>
                <li class="breadcrumb-item"><a href="{{ url('/' . ($page = '#')) }}">Periksa Kebuntingan</a></li>
                </li>
            </ol>
        </div>
        <div class="page-rightheader">
            <div class="btn btn-list">
                ...
                {{-- <button wire:click="openAddGrafik" class="btn btn-warning"><i class="fe fe-activity mr-1"></i>
                    Grafik </button> --}}
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12" wire:ignore>
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Grafik Periksa Kebuntingan</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="text-center mt-2">
                        ...
                        <span><span class="dot-label bg-warning"></span>Data Periksa Kebuntingan</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- grafik Form Modal -->
        <div class="modal fade" role="dialog" tabindex="-1" id="grafik-modal">
            <div class="modal-dialog" role="document">
                @livewire('pkb.wire-pkb-grafik')
            </div>
        </div>
    </div>
</div>
